...
gTextures = {
    ...
    ['Flareon-back'] = love.graphics.newImage('graphics/pokemon/Flareon-back.png'),
    ['Flareon-front'] = love.graphics.newImage('graphics/pokemon/Flareon-front.png'),
    ['Glaceon-back'] = love.graphics.newImage('graphics/pokemon/Glaceon-back.png'),
    ['Glaceon-front'] = love.graphics.newImage('graphics/pokemon/Glaceon-front.png'),
    ['Leafeon-back'] = love.graphics.newImage('graphics/pokemon/Leafeon-back.png'),
    ['Leafeon-front'] = love.graphics.newImage('graphics/pokemon/Leafeon-front.png'),
    ['Poiseon-back'] = love.graphics.newImage('graphics/pokemon/Poiseon-back.png'),
    ['Poiseon-front'] = love.graphics.newImage('graphics/pokemon/Poiseon-front.png'),
    ['Rockeon-back'] = love.graphics.newImage('graphics/pokemon/Rockeon-back.png'),
    ['Rockeon-front'] = love.graphics.newImage('graphics/pokemon/Rockeon-front.png'),
}
